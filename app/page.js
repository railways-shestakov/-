  ...
  return (
    <main>
      <nav className={styles.nav}>
        <a href="#" className={styles.logo}>NOVA<span>.</span></a>
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroCopy}>
          ...
          <div className={styles.heroActions}>
            <a href="#contact" className={styles.primaryButton}>Start building <span>→</span></a>
            <a href="#features" className={styles.secondaryButton}>Explore features</a>
          </div>
          <div className={styles.trust}>
            <div className={styles.avatars}>
              <span>JD</span><span>AM</span><span>SK</span><span>+</span>
            </div>
            <div><strong>2,000+</strong><small>teams already moving forward</small></div>
          </div>
        </div>
        ...
        <div className={styles.heroVisual} aria-hidden="true">
          ...
          <div className={`${styles.floatingCard} ${styles.cardBottom}`}>
            ...
            <div><strong>Ready to launch</strong><small>Everything is on track.</small></div>
          </div>
        </div>
      </section>

      <section className={styles.marquee}>
        <span>DESIGNED FOR AMBITION</span><b>✦</b>
        <span>BUILT FOR MOMENTUM</span><b>✦</b>
        <span>MADE TO MOVE</span><b>✦</b>
      ...
      <section id="about" className={styles.statement}>
        ...
        <a href="#contact" className={styles.primaryButton}>Let&apos;s talk <span>→</span></a>
      </section>

      <footer id="contact" className={styles.footer}>
        <div>
          <a href="#" className={styles.logo}>NOVA<span>.</span></a>
          <p>A modern landing page starter for your next big idea.</p>
        </div>
